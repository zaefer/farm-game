                  ...
                  (player) => (
                    ...
                    >
                      ...
                      <td className="px-5 py-4">
                        ...
                        <Link
                          href={`/admin/players/${player.id}`}
                          className="inline-flex rounded-xl border border-white/10 bg-white/5 px-4 py-2 text-xs font-semibold text-white transition hover:border-green-500/30 hover:bg-green-500/10 hover:text-green-300"
                        >
                          View Player →
                        </Link>
