...
export default async function BannedPage({
  ...
  if (hasExpired) {
    return (
      <main className="min-h-screen bg-[#0F1813] px-4 py-12 text-white">
        <div className="mx-auto max-w-lg rounded-[32px] border border-green-500/20 bg-[#142019] p-8 text-center">
  ...
  return (
    <main className="min-h-screen bg-[#0F1813] px-4 py-12 text-white">
      <div className="mx-auto max-w-lg">
        ...
        <div className="rounded-[32px] border border-red-500/20 bg-[#142019] p-7 md:p-9">
...
function InvalidBanPage() {
  return (
    <main className="min-h-screen bg-[#0F1813] px-4 py-12 text-white">
      <div className="mx-auto max-w-lg rounded-[32px] border border-red-500/20 bg-[#142019] p-8 text-center">
