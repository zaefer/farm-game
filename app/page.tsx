...
export default function Home() {
  ...
  // CURRENT TIME
  //
  // Render sırasında Date.now() çağırmıyoruz.
  // Zaman bilgisi effect içindeki timer tarafından
  // state'e yazılıyor.
  // =====================================================
  ...
  useEffect(() => {
    ...
    // İlk zamanı effect tamamlandıktan sonra al.
    const firstTimer =
      window.setTimeout(
        updateTime,
        0
    ...
    // Sonrasında her saniye güncelle.
    const interval =
      window.setInterval(
        updateTime,
        1000
          ...
          <div className="mx-auto max-w-7xl">
            ...
            <div className="rounded-[28px] bg-white p-10 text-center shadow-sm">
              ...
              <p className="mt-2 text-sm text-stone-500">
                Getting your current season farm from the server.
              </p>
